const wordPacks = {
  ...
  "Comida": [
    "Pizza", "Hamburguesa", "Sushi", "Helado", "Milanesa", "Empanada",
    "Asado", "Tacos", "Ensalada", "Pan"
  ],
  "Animales": [
    "Perro", "Gato", "Leon", "Tiburon", "Aguila", "Delfin", "Caballo",
    "Pinguino", "Mono", "Elefante"
  ],
  "Lugares": [
    "Playa", "Escuela", "Hospital", "Aeropuerto", "Cine", "Supermercado",
    "Biblioteca", "Gimnasio", "Hotel", "Restaurante"
  ]
}
